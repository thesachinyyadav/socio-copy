...
const AboutPage = () => {
  const features = [
    {
      icon: (
        <svg
          ...
          className="h-6 w-6 sm:h-8 sm:w-8 md:h-12 md:w-12 lg:h-14 lg:w-14 text-[#2563EB]"
        >
  ...
  return (
    <div className="min-h-screen ">
      <div className="bg-gradient-to-b from-[#1E3A8A] to-[#3B82F6] text-white">
        <div className="container mx-auto px-4 py-12 md:py-16 max-w-7xl">
          <div className="max-w-3xl text-left">
            ...
            <Link
              href="/Discover"
              className="inline-flex items-center justify-center w-auto bg-[#F59E0B] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#D97706] transition-all"
            >
              Explore events
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="py-12 md:py-16 container mx-auto px-4 max-w-7xl">
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            <div className="md:w-1/2">
            <h2 className="text-2xl md:text-3xl font-black text-[#2563EB] mb-6">
              Our Mission
            </h2>
            ...
            <div className="bg-amber-50 border-l-4 border-[#F59E0B] p-4 rounded">
              ...
              <p className="mt-2 text-sm md:text-base font-medium text-[#2563EB]">
                — Sachin Yadav
              </p>
            </div>
          </div>
      ...
      <section className="py-12 md:py-16 bg-blue-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <h2 className="text-2xl md:text-3xl font-black text-[#2563EB] mb-6 text-center">
            What we offer
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow-sm hover:shadow-md transition-all border-b-4 border-[#F59E0B] flex flex-col"
              >
      ...
      <section className="py-12 md:py-16 container mx-auto px-4 max-w-7xl">
        ...
        <div className="mb-8 flex flex-col items-center">
          <div className="relative w-full max-w-2xl mx-auto overflow-hidden rounded-lg shadow-lg mb-6">
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#2563EB]/80 to-transparent p-4">
              <p className="text-white text-center font-medium">
          Our founders: Sachin, Surya, and Meeth
              </p>
            </div>
          </div>
          <div className="w-16 h-1 bg-[#F59E0B] rounded-full mb-6"></div>
        </div>
        ...
        <div className="bg-gradient-to-r from-[#2563EB] to-[#1E3A8A] py-8 px-4 rounded-xl mb-12">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-4 md:gap-6 text-center">
          <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg shadow-sm border-t-4 border-[#F59E0B]">
            <div className="flex justify-center mb-1 sm:mb-2 md:mb-4">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="h-6 w-6 sm:h-8 sm:w-8 md:h-12 md:w-12 lg:h-14 lg:w-14 text-[#F59E0B]"
              >
            ...
            <div className="text-base sm:text-xl md:text-3xl font-bold text-[#2563EB]">
              4+
            </div>
          ...
          <div className="bg-white p-3 sm:p-4 md:p-6 rounded-lg border-t-4 shadow-sm border-[#F59E0B]">
            <div className="flex justify-center mb-1 sm:mb-2 md:mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 shadow-sm relative">
              <div className="text-[#2563EB] text-5xl font-serif absolute -top-4 left-4">"</div>
